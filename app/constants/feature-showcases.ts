...
export const FeatureShowcases: FeatureShowcase[] = [
    ...
    },
    {
        ...
        description: "Make informed gaming choices with real <b class='text-primary-300'>user reviews</b> and <b class='text-primary-300'>ratings</b>. Explore what players love (or don’t) about each game, <b class='text-primary-300'>share your own experiences</b>, and <b class='text-primary-300'>connect</b> with a community that values honest opinions. Whether you're searching for a hidden gem or the next big hit, <b class='text-primary-300'>let reviews guide your next adventure</b>!",
        image: 'bg7.png'
    },
    {
        title: 'Create & Customize Your Ultimate Game List',
        description: "Easily <b class='text-primary-300'>save</b> and <b class='text-primary-300'>organize</b> your favorite games in one place! Build your <b class='text-primary-300'>personalized game list</b>, keep track of the titles you love, and revisit them anytime. Whether you're creating a must-play <b class='text-primary-300'>backlog</b> or showcasing your <b class='text-primary-300'>top picks</b>, your <b class='text-primary-300'>collection</b> is always just a click away.",
        image: 'bg5.png'
    },
