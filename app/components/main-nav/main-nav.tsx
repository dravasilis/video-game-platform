  ...
  return (
    <>
      <div className="flex flex-col gap-4 py-4 animate-fade-in px-4 ">
        ...
        >
          {header && (
            <div className="flex justify-between w-full max-md:flex-col max-md:items-start max-md:gap-4 items-center z-[9] px-20 max-lg:px-10 max-md:px-4 max-[540px]:!px-0 pt-8">
